...
class FirstInputPreviewVC: PreviewBaseVC {
    ...
    override func initData() {
        ...
        let firstInput = MdlFirstInput(nickname: "", gender: "", birthday: Date(), hopeArea: [], school: "", employmentStatus: "", lastJobExperiment: MdlJobExperiment(jobType: "", jobExperimentYear: ""), salary: "", jobExperiments: [])
