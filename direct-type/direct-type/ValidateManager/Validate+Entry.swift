...
extension EditItemMdlEntry {
    var valid: ValidInfo {
        ...
        case .exQuestionAnswer1:    return ValidInfo(required: true, keta: nil, max: 1000, type: .zenkaku)
        case .exQuestionAnswer2:    return ValidInfo(required: true, keta: nil, max: 1000, type: .zenkaku)
        case .exQuestionAnswer3:    return ValidInfo(required: true, keta: nil, max: 1000, type: .zenkaku)
