...
extension ValidateManager {
    class func makeGrpErrByItemErr(_ dicError: [EditableItemKey: [String]]) -> ([MdlItemHTypeKey: [String]]) {
        ...
        for (key, val) in dicError {
            ...
            case EditItemMdlProfile.birthday.itemKey: dicGrpError.addDicArrVal(key: HPreviewItemType.birthH2.itemKey, val: val)
            case EditItemMdlProfile.gender.itemKey: dicGrpError.addDicArrVal(key: HPreviewItemType.genderH2.itemKey, val: val)
