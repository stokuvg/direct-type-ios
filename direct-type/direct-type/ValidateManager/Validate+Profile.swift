...
extension EditItemCareerCard {
    var valid: ValidInfo {
        ...
        case .companyName:      return ValidInfo(required: true, keta: nil, max: 50, type: .hiraKataKan)
        ...
        case .contents:         return ValidInfo(required: true, keta: nil, max: 2000, type: .hiraKataKan)
        }
    }
}
